...
ROOK_EXTERNAL_FSID=dbb65d50-cee5-480e-8f30-dd0670719167
ROOK_EXTERNAL_USERNAME=client.healthchecker
ROOK_EXTERNAL_CEPH_MON_DATA=pve-ms01-a=10.10.10.50:3300
ROOK_EXTERNAL_USER_SECRET=AQBI+6RnGIAcFRAAFWVY7kdXtZ1fKBXc0sHa2g==
CSI_RBD_NODE_SECRET=AQBI+6RnkImPFRAAFGoTEO6C462OpJgt7fQEqA==
CSI_RBD_NODE_SECRET_NAME=csi-rbd-node
CSI_RBD_PROVISIONER_SECRET=AQBI+6RnS2H8FRAAsuwhgNhSOggvL34KWVfH8A==
...
CSI_CEPHFS_NODE_SECRET=AQBI+6RndxRqFhAA8gRhX/5N4ljcdalW6nItNw==
CSI_CEPHFS_PROVISIONER_SECRET=AQBI+6RnucPMFhAASHR4lCrths04lDKjk84FUA==
CSI_CEPHFS_NODE_SECRET_NAME=csi-cephfs-node
CSI_CEPHFS_PROVISIONER_SECRET_NAME=csi-cephfs-provisioner
MONITORING_ENDPOINT=10.10.10.50
MONITORING_ENDPOINT_PORT=9283
RBD_POOL_NAME=opstimus
RGW_POOL_PREFIX=default
RGW_ENDPOINT=10.10.10.50:7480
RGW_ADMIN_OPS_USER_ACCESS_KEY=X2SDT56QLH9UAZ25IP4P
RGW_ADMIN_OPS_USER_SECRET_KEY=VynKyzbv4i6bV7ak4F3yT6sDDVTBNvCdZap8AX7K
